...
<?php echo form_open('dashboard/saveshipping', 'class="form-horizontal" id="form-save-package"');?>
    
    <div class="form-group">
		<?php echo form_label('Name City','nama_kota', array('class'=>'col-sm-2 control-label'));?>
		<div class="col-sm-10">

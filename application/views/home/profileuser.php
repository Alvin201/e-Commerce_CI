...
<br/>
             ...
             <div class="col-md-12">
              ...
              <div class="col-md-12">
                ...
                <?php echo validation_errors(); ?>
							...
							<div class="col-md-6">
							<form class="form-horizontal" action="<?php echo base_url('welcome/updateprofile') ?>" method="POST" enctype="multipart/form-data">

                  <div class="form-group">
                      <label>Profile Kamu</label>
                      <br/>
                      <?php 
                      if (empty($this->session->userdata('user_pic'))):?>
                      <img class="img-circle" height="100" width="100" alt="" src="../upload/npa.jpg">
                      <?php else: ?>
 ...
 <!-- Modal UPLOAD -->     
      <form class="form-horizontal style-form" action="<?php echo base_url(). 'welcome/updatefotoprofile'; ?>" method="post" enctype="multipart/form-data">
